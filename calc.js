...
$(document).ready(function(){
	...
	function calc_auto () {
		...
		var auto_price = Number($(".js-car-price").val()),
				...
				rastamoj = 0,
				expedir = 750,
				avtopmr=document.getElementById("DimaBlond").value,
				 //Number($('.js-calc-avtopmr').val()),
		...
		total_price = parseInt(auto_price) + parseInt(acciz) + parseInt(poshlina) + parseInt(nds) + parseInt(region == 'ua' ? 0 : rastamoj) + ship1 + ship2 + parseInt(comission) + parseInt(avtopmr) + expedir;
